...
var formatBackboneCollection = require('./format-backbone-collection');
var formatFindAllOptions = require('./format-find-all-options');
...
module.exports = function (options) {
  ...
  return function (req, res, next) {
    ...
    .exec(function (err, output) {
      ...
      res.body = formatBackboneCollection(output);
